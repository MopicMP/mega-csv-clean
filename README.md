...
> Mega clean and normalize csv data

[![PyPI version](https://badge.fury.io/py/mega-csv-clean.svg)](https://pypi.org/project/mega-csv-clean/)
...
```bash
pip install mega-csv-clean
```

## Quick Start

```python
from mega_csv_clean import clean

# Basic usage
result = clean("your input here")
print(result)
```
...
from mega_csv_clean import batch
